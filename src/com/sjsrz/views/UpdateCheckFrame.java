...
public class UpdateCheckFrame extends JFrame {
	JFrame parentFrame;
	private static final int DEFAULT_WIDTH = 300;
	private static final int DEFAULT_HEIGHT = 300;
	
	public UpdateCheckFrame(String title) { 
		//设置窗体大小
		...
		UpdateCheckPanel loginPanel = new UpdateCheckPanel(); 
	...
	private class UpdateCheckPanel extends JPanel {
		//定义登陆容器Panel中的控件元素。
		
		JButton backButton,upButton; 
	...
	public static void main(String[] args) {
		...
		UpdateCheckFrame frame = new UpdateCheckFrame("登陆主窗口");
	}
}
